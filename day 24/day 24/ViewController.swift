...
//  day 24
//
//  Created by m Al-qhtani on 21/03/1443 AH.
//
...
class ViewController: UIViewController {
    ...
    @objc func saveData() {
        ...
        let alertController = UIAlertController(title: "in", message: "Data Saved", preferredStyle: .alert)
