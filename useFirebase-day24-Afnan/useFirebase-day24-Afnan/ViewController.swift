...
//  useFirebase-day24-Afnan
//
//  Created by Fno Khalid on 22/03/1443 AH.
//
...
class ViewController: UIViewController {
  ...
  @objc func saveData() {
    ...
    let alertController = UIAlertController(title: "💾", message: "DataSaved", preferredStyle: .alert)
  ...
  @objc func showSavedData() {
    Firestore
      .firestore()
      .collection("users")
      .whereField("name", isEqualTo: "Afnan")
